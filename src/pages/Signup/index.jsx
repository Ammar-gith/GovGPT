        ...
        <div className="flex items-center h-[calc(100vh-125px)] bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl">
                <div className="relative bg-white shadow-2xl rounded-3xl flex">
                    ...
                    <div className="w-1/2 bg-gradient-to-r from-brightgreen to-darkgreen rounded-l-3xl text-white p-12 flex flex-col items-center justify-center text-center">
                        <h2 className="text-4xl font-bold mb-6">Welcome Back!</h2>
                        <p className="mb-8 text-lg">To keep connected with us please login with your personal info</p>
                        <Link to="/login" className="border-2 border-white text-white hover:bg-white hover:text-brightgreen rounded-full px-8 h-12 flex items-center justify-center">SIGN IN</Link>
                    </div>
                        ...
                        <div className="max-w-sm mx-auto space-y-8">
                            ...
                            <form className="space-y-6">
                                ...
                                <input
                                    ...
                                    required
                                />
                                <Link to="" className="font-sans text-lg w-full bg-brightgreen hover:bg-darkgreen text-white rounded-full px-8 h-12 flex items-center justify-center"> SIGN UP </Link>
                            </form>
                        </div>
                    </div>
                </div>
